...
- 승인 카드와 수기 확정 화면의 부품이 같아진다(크롭 · 원본 토글 · 출처 표시). ~~화면 설계는 #9·#10이 이어받는다.~~ **정정(#23, 2026-09-22)**: 두 화면의 설계는 #8의 소관이다(`docs/PRD.md:172`). #8은 결과를 남기고 닫혔다(<https://github.com/DHChe/E2EAI_business_proj/issues/8#issuecomment-5769586450>).
